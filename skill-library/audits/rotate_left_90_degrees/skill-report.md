# Skill report: skill-rotate_left_90_degrees
...
- **Title:** Rotate left 90.00 deg
- **Subtitle:** Publishes /cmd_vel_requested at 0.40 rad/s for 3.93 s, then zero.
- **Risk band:** `guarded`
...
- `angle_degrees` = `90.0` (deg)
- `direction` = `left` (unitless)
...
# --- bounded parameters -----------------------------------------------
ANGLE_DEG = 90.00            # requested angle magnitude
...
- [info] `request_accepted`: rotate left 90.0 degrees
