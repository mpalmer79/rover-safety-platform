# Skill report: skill-move_forward_6_feet
...
- **Subtitle:** Publishes /cmd_vel_requested at 0.25 m/s for 7.32 s, then zero.
- **Risk band:** `guarded`
...
- `distance_meters` = `1.8288` (m)
- `source_distance` = `6.0` (ft)
...
# --- bounded parameters -----------------------------------------------
DISTANCE_M = 1.8288           # requested distance
...
- [info] `request_accepted`: converted 6.0 feet to 1.8288 meters
