...
export const metadata = {
  title: "Start Here · ProjectBoundary",
  description:
    "Reviewer entry point: what ProjectBoundary demonstrates, where to click first, and what the demo proves.",
};
...
const SCOPE = [
  "Validates robot mission requests before simulated execution.",
  "Rejects unsafe commands before they reach motion authority.",
  "Preserves runtime safety-supervisor authority on every path.",
  "Records deterministic evidence for replay and audit.",
] as const;
    ...
    <PageSurface variant="hero">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <Panel eyebrow="In scope" title="What ProjectBoundary does">
          ...
          <Panel eyebrow="Out of scope" title="What ProjectBoundary does not claim">
            <ul className="space-y-1.5 text-sm text-[color:var(--mc-text)]">
