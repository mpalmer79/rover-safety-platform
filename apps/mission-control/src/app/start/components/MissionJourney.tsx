...
const STEPS: readonly Step[] = [
  {
    ...
    copy: "Deterministic warehouse mission. Watch the rover glide an approved route in 3D.",
    icon: PlayCircle,
  },
  {
    n: "02",
    href: "/safety",
    title: "Inspect the supervisor",
    copy: "The authority boundary that blocks unsafe commands before motion is issued.",
    icon: ShieldCheck,
  },
  {
    n: "03",
    ...
    copy: "Follow an accepted and a rejected intent through validator and supervisor.",
    icon: Workflow,
  },
  {
    n: "04",
    ...
    copy: "Hashes, requirements, and replay bundles behind every decision.",
    icon: FileSearch,
  },
  {
    n: "05",
    ...
    copy: "End-to-end reviewer walkthrough of the mission pipeline.",
    icon: ClipboardList,
  },
];
