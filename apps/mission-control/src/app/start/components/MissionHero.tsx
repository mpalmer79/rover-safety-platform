...
import { HeroMissionPreview } from "./HeroMissionPreview";
...
export function MissionHero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative grid items-center gap-7 lg:grid-cols-[1fr_1.05fr] lg:gap-10">
        <div className="space-y-5">
          ...
          >
            Replay a simulated rover mission and
            {" "}<span className="bg-gradient-to-r from-emerald-300 via-cyan-300 to-sky-300 bg-clip-text text-transparent">inspect every safety decision</span>
            {" "}— approved, rejected, and audited.
          </motion.h1>

          <motion.p {...fade(0.12)} className="max-w-xl text-base text-slate-200/90 sm:text-lg">
            ProjectBoundary validates mission requests, blocks unsafe commands
            before motion authority, and records deterministic evidence for
            review. Simulation only. Not safety-certified. Does not control real
            hardware.
          </motion.p>
