...
export const metadata = {
  title: "Mission Control · Operator Dashboard",
  description:
    "Operator dashboard surfacing rehearsal audits, governance health, and requirement coverage from committed JSON artifacts.",
};

export default async function MissionControlDashboardPage() {
