...
- **Run id:** `static-2026-05-09`
- **Mode:** `static-only`
- **Generated:** 2026-05-09T21:28:29+00:00
...
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/node-snapshot.json` |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/launch-log.txt` |
| `topic_probe` | `not_executed` | live topic graph not exercised; ran static-only mode |
|   _reason_ |   | rclpy not importable: No module named 'rclpy' |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/topic-snapshot.json` |
| `tf_probe` | `not_executed` | live tf graph not exercised; ran static-only mode (URDF link/joint check passed) |
|   _reason_ |   | rclpy not importable: No module named 'rclpy' |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/tf-snapshot.json` |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/tf-tree.txt` |
| `command_path_probe` | `passed` | 4 command-path invariant(s) verified statically |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/command-path-audit.json` |
| `runtime_capture[stale_lidar_restricted_mode]` | `passed` | deterministic-engine capture: scenario stale_lidar_restricted_mode => passed |
|   _evidence_ |   | `evidence/runtime/static-2026-05-09/runtime-capture-stale_lidar_restricted_mode.json` |
...
- Static-only mode validates the workspace artifacts (launch files, URDF, bridge YAML, node modules). It does not exercise the safety bridge against a live actuator stream.
