...
- **Generated:** 2026-05-09T20:27:02+00:00
...
|---|---|---|---|---|---|---|
| `nominal_run` | `passed` | `ACTIVE_NORMAL` | `-` | - | 0 | `/tmp/p3-final-runs/verify-nominal_run` |
| `stale_lidar_restricted_mode` | `passed` | `SAFE_STOP` | `-` | `f-stale-lidar` | 0 | `/tmp/p3-final-runs/verify-stale_lidar_restricted_mode` |
| `odometry_divergence_safe_stop` | `passed` | `ACTIVE_DEGRADED` | `-` | `f-disagreement` | 0 | `/tmp/p3-final-runs/verify-odometry_divergence_safe_stop` |
| `command_timeout_safe_stop` | `passed` | `SAFE_STOP` | `-` | `f-cmd-timeout` | 0 | `/tmp/p3-final-runs/verify-command_timeout_safe_stop` |
| `bridge_disconnect_safe_stop` | `passed` | `SAFE_STOP` | `-` | `f-bridge` | 0 | `/tmp/p3-final-runs/verify-bridge_disconnect_safe_stop` |
| `wheel_slip_degraded_mode` | `passed` | `ACTIVE_DEGRADED` | `-` | `f-imu-bias`, `f-slip` | 0 | `/tmp/p3-final-runs/verify-wheel_slip_degraded_mode` |
| `estop_latched_manual_reset_required` | `passed` | `E_STOP_LATCHED` | `-` | - | 0 | `/tmp/p3-final-runs/verify-estop_latched_manual_reset_required` |
| `nominal_waypoint_patrol` | `passed` | `ACTIVE_NORMAL` | `MISSION_COMPLETE` | - | 1 | `/tmp/p3-final-runs/verify-nominal_waypoint_patrol` |
| `waypoint_timeout_recovery` | `passed` | `ACTIVE_NORMAL` | `MISSION_ABORTED` | - | 4 | `/tmp/p3-final-runs/verify-waypoint_timeout_recovery` |
| `degraded_sensor_navigation` | `passed` | `ACTIVE_DEGRADED` | `MISSION_COMPLETE` | `f-imu-bias` | 1 | `/tmp/p3-final-runs/verify-degraded_sensor_navigation` |
| `keepout_zone_violation` | `passed` | `ACTIVE_NORMAL` | `MISSION_DEGRADED` | - | 2 | `/tmp/p3-final-runs/verify-keepout_zone_violation` |
| `restricted_mode_navigation` | `passed` | `ACTIVE_NORMAL` | `MISSION_COMPLETE` | - | 1 | `/tmp/p3-final-runs/verify-restricted_mode_navigation` |
| `safe_stop_during_active_mission` | `passed` | `SAFE_STOP` | `MISSION_DEGRADED` | `f-stale-lidar` | 2 | `/tmp/p3-final-runs/verify-safe_stop_during_active_mission` |
| `mission_abort_after_fault_escalation` | `passed` | `ACTIVE_NORMAL` | `MISSION_ABORTED` | - | 5 | `/tmp/p3-final-runs/verify-mission_abort_after_fault_escalation` |
